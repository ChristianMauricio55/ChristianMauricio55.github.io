                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <h2 class="text-white">eCommerce Películas</h2>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="ratio ratio-16x9">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/6v79eI0HeUQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h2 class="mb-lg-5 mb-4">Conocer mas</h2>
                        </div>

                        <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                            <h3 class="mb-3">eCommerce peliculas</h3>

                            <p><strong></strong>Se desarrollo utilizando php, css, javaScript</p>

                            <p>El sistema dispone de un crud completo, una base de datos, es administrable con una interfaz de administrador que se requiere iniciar sesión perfectamente para un negocio, se puede realizar ventas con su respectivo carrito de compras y pedidos e impresión de tickets</p>
                        </div>

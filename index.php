...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="logo" href="#">Myportafolio</a>
            <ul class="nav">
                <li class="item">
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am Christian Mauricio</span>
            </h1>
            <p class="header-subtitle">Tecnologias de la Informacion</p>
        ...
        <div class="container text-center">
            ...
            <div class="about">
                <div class="about-img-holder">
                    <img src="assets/imgs/man1.png" class="about-img"
                        alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                </div>
                <div class="about-caption">
                    <p class="section-subtitle">Quién soy ?</p>
                    <h2 class="section-title mb-3">Acerca de mí</h2>
                    <p>
                        CONOCIMIENTOS A NIVEL USUARIO:<br>
                            Mantenimiento correctivo (Limpieza de equipos de computo, modificaciones en la 
                            instalación o en el equipamiento para devolverlo a su estado original)
                            Mantenimiento preventivo (Verificar el buen estado del equipamiento o de la 
                            instalación sin necesidad de defecto alguno o de que presente un mal funcionamiento)
                            Desarrollor web 
                            Paquete Microsoft Office
                            NetBeans - Unity- Visual Studio Code
                            Java - PHP - JavaScript - (HTML - CSS).
                            WampServer – XAMPP - MySQL Workbench.
    ...
    <section class="section" id="service">
        <div class="container text-center">
            <p class="section-subtitle">Lo que hago ?</p>
                    ...
                    <div class="service-card">
                        <div class="body">
                            <img src="assets/imgs/pencil-case.svg"
                                alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page"
                                class="icon">
                            <h6 class="title">Diseño Web</h6>
                            <p class="subtitle">Diseño personalizado de sitios web
                                </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="service-card">
                        <div class="body">
                            <img src="assets/imgs/responsive.svg"
                                alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page"
                                class="icon">
                            <h6 class="title">Desarrollo de Software</h6>
                            <p class="subtitle">Desarrollo de sitio web, sistema de punto de venta, eCommerce</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            <img src="assets/imgs/toolbox.svg"
                                alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page"
                                class="icon">
                            <h6 class="title">Soporte Tecnico</h6>
                            <p class="subtitle">Mantenimiento correctivo y
                    ...
                    <div class="service-card">
                        <div class="body">
                            <img src="assets/imgs/analytics.svg"
                                alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page"
                                class="icon">
                            <h6 class="title">Base de datos</h6>
                            <p class="subtitle">Creacion de base de datos para sistemas web</p>
                        </div>
                    </div>
                </div>
            </div><!-- end of row -->
    ...
    <section class="section" id="portfolio">
        <div class="container text-center">
            <p class="section-subtitle">Lo que hice ?</p>
        ...
        <hr/>
                <a href="video/upload.php" class="btn btn-primary mt-3">Subir un nuevo video</a>
                <hr/>
        <div class="row">
                <?php
                include("video/db.php");
...
<source src="<?php echo 'video/upload/'.$name;?>">
</video>
                    </div>
...
?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="portada/peliculas.php" class="portfolio-card">
                        <img src="assets/imgs/folio-1.jpg" class="portfolio-card-img"
                            alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>eCommerce Películas</h5>
